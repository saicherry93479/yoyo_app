    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 justify-between">
        ...
        <View className="flex-row items-center justify-between px-4 py-4 border-b border-gray-100 bg-white">
          ...
          <Text className="text-[#161312] text-xl font-bold text-center flex-1" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
            Checkout
          </Text>
          <View className="w-10" />
        </View>
        ...
        <ScrollView className="flex-1 px-6 py-6">
          ...
          <View className="flex-row items-center bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-6">
            ...
            <View className="flex-1 ml-4">
              ...
              <Text className="text-[#161312] text-lg font-bold mt-1" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
                Deluxe King Room
              </Text>
          ...
          {/* Your Trip Section */}
          <View className="mb-6">
            <Text className="text-[#161312] text-lg font-bold mb-4" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
              Your Trip
            </Text>
            <View className="space-y-4">
              <View className="flex-row items-center justify-between">
                ...
                <TouchableOpacity>
                  <Text className="text-[#e1a9a1] text-sm font-bold" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
                    Edit
                  </Text>
                </TouchableOpacity>
              </View>
          ...
          <View className="mb-6">
            ...
            <View className="space-y-3">
              ...
              <View className="border-t border-gray-100 pt-2">
                <View className="flex-row justify-between">
                  <Text className="text-[#161312] text-base font-bold" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
                    Total
                  </Text>
                  <Text className="text-[#161312] text-base font-bold" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
                    $1,375.00
          ...
          <View className="mb-6">
            <Text className="text-[#161312] text-lg font-bold mb-3" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
              Cancellation Policy
            </Text>
            <Text className="text-gray-600 text-sm leading-relaxed" style={{ fontFamily: 'PlusJakartaSans-Regular' }}>
              ...
              <Text className="text-[#e1a9a1] font-bold" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
                Learn more
              </Text>
            </Text>
          </View>
        ...
        <View className="px-4 py-4 border-t border-gray-100 bg-white">
          <TouchableOpacity className="bg-[#e1a9a1] rounded-full h-14 flex-row items-center justify-center shadow-lg">
            <Text className="text-white text-base font-bold tracking-wide" style={{ fontFamily: 'PlusJakartaSans-Bold' }}>
              Confirm and Pay
            </Text>
          </TouchableOpacity>
        </View>
