            ...
            <View className="flex-row flex-wrap gap-2">
              {sortOptions.map((option) => (
                ...
                >
                  <Text 
                    className={`text-sm ${
                      filters.sortBy === option.id ? 'text-white' : 'text-gray-700'
                    }`}
            ...
            <View className="gap-2">
              {[4, 3, 2, 1].map((rating) => (
                ...
                >
                  ...
                  <Text 
                    className={`text-base ${
                      filters.rating === rating ? 'text-red-700' : 'text-gray-700'
                    }`}
                    style={{ fontFamily: 'PlusJakartaSans-Medium' }}
                  >
                    {rating}+ stars
            ...
            <View className="flex-row flex-wrap gap-2">
              {propertyTypes.map((type) => (
                ...
                >
                  <Text 
                    className={`text-sm ${
                      filters.propertyType.includes(type) ? 'text-white' : 'text-gray-700'
                    }`}
                    style={{ fontFamily: 'PlusJakartaSans-Medium' }}
                  >
                    {type}
